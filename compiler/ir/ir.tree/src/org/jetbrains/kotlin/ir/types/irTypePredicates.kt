...
fun IrType.isUByteOrNullable(): Boolean = isClassType(IdSignatureValues.uByte)
fun IrType.isUShort(): Boolean = isNotNullClassType(IdSignatureValues.uShort)
fun IrType.isUShortOrNullable(): Boolean = isClassType(IdSignatureValues.uShort)
fun IrType.isUInt(): Boolean = isNotNullClassType(IdSignatureValues.uInt)
fun IrType.isUIntOrNullable(): Boolean = isClassType(IdSignatureValues.uInt)
fun IrType.isULong(): Boolean = isNotNullClassType(IdSignatureValues.uLong)
fun IrType.isULongOrNullable(): Boolean = isClassType(IdSignatureValues.uLong)
