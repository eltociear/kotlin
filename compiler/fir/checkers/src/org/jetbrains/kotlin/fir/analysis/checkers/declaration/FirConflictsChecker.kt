...
object FirConflictsChecker : FirBasicDeclarationChecker() {
    ...
    private class DeclarationInspector : FirDeclarationInspector() {
        ...
        private fun areCompatibleMainFunctions(declaration1: FirDeclaration, declaration2: FirDeclaration, session: FirSession): Boolean {
            ...
            val file1 = session.firProvider.getFirCallableContainerFile(declaration1.symbol)
            val file2 = session.firProvider.getFirCallableContainerFile(declaration2.symbol)
            return file1 != file2
        }
        ...
        private fun collectExternalConflict(
            ...
            if (areCompatibleMainFunctions(declaration, conflicting, session)) return
